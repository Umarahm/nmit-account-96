...
import { CreateContactRequest, Address, TaxInfo, ContactProfile } from "@/types/contacts";
...
export default function NewContactPage() {
    ...
    const [formData, setFormData] = useState<CreateContactRequest>({
        type: (searchParams.get('type') as 'CUSTOMER' | 'VENDOR' | 'BOTH') || 'CUSTOMER',
        name: '',
        displayName: '',
        email: '',
        mobile: '',
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push(`/dashboard/contacts/${result.contact.id}`);
        } catch (error) {
            console.error('Error creating contact:', error);
            setErrors({ submit: error instanceof Error ? error.message : 'Failed to create contact' });
        } finally {
            setLoading(false);
        }
    };
                    ...
                    <TabsContent value="business" className="space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Enter tax-related details for compliance
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <TabsContent value="additional" className="space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Enter additional details and notes
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
