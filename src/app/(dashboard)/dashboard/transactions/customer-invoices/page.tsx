...
export default function CustomerInvoicesPage() {
    ...
    const customerInvoices = invoices.filter((invoice) => invoice.type === "SALES");
    const vendorBills = invoices.filter((invoice) => invoice.type === "PURCHASE");
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <Button asChild>
                    <Link href="/dashboard/transactions/customer-invoices/new">
                ...
                <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Button variant="outline" onClick={fetchInvoices} className="w-full">
                                Refresh
                            </Button>
                        </div>
                    </div>
                            ...
                            <div className="text-right space-y-2">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <Button variant="outline" size="sm" asChild>
                                        <Link href={`/dashboard/transactions/customer-invoices/${invoice.id}`}>
