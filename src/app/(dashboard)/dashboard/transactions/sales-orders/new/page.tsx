...
export default function NewSalesOrderPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push(`/dashboard/transactions/sales-orders/${data.order.id}`);
        } catch (err) {
    ...
    if (!session) {
        return (
            ...
            >
                <div className="flex items-center justify-center min-h-[400px]">
                    <div className="text-center">
                        <p>Please sign in to create sales orders.</p>
                    </div>
                </div>
            </DashboardPageLayout>
        );
        ...
        <DashboardPageLayout
            ...
            actions={
                <Button variant="outline" asChild>
                    <Link href="/dashboard/transactions/sales-orders">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Basic information for the sales order
                        </CardDescription>
                    </CardHeader>
                ...
                <div className="flex justify-end space-x-4">
                    <Button type="button" variant="outline" asChild>
                        <Link href="/dashboard/transactions/sales-orders">Cancel</Link>
                    </Button>
